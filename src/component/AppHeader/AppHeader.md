...
The `AppHeader` component is designed to display a header over required screens. It provides a flexible and reusable structure for displaying screen heading, language selector and logout selector at the top of the screen.

...
1. Used to display additional text information or a title about any element or feature, passed as a prop.

#### Input Props:

1. title: string —> This prop accepts the text to be displayed in the tooltip (popper) when the user hovers over the associated icon.
